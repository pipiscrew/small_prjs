...
namespace MenuBuilder
{
    class Menu
    {
        ...
        {
            System.Console.CursorVisible = System.Console.CursorVisible != true;
        }

        public void SetCursorPosition(int row, int column)
        {
            if (row > 0 && row < System.Console.WindowHeight)
            {
                System.Console.CursorTop = row;
            }

            if (column > 0 && column < System.Console.WindowWidth)
            {
        ...
        private void DrawMenu()
        {
            ...
            for (int i = 0; i < _menuList.Count; i++)
            {
                ...
                if (i == _currentSelection)
                {
                    ...
                    SetConsoleTextColor(ConsoleColor.Yellow, ConsoleColor.DarkRed);
