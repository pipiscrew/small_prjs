...
get_articles('https://jobs.citrix.com/widgets');
...
function get_articles($srcURL)
{
    ...
    foreach ($jobs as $item) {
		...
		$obj->link = 'https://jobs.citrix.com/job/'.$item->jobId;
        //$objArr[] = $obj;
		$db->addRecord($obj->title, $obj->link, 2);
    }
...
function log_exception( Exception $e )
{
    ...
    file_put_contents('citrix_errors.txt',  $message.PHP_EOL , FILE_APPEND | LOCK_EX);
