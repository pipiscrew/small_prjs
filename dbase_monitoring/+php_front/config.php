...
function connect_sqlite() {
	...
	$d = getScalar($dbh, "select count(*) from usaaa",null);
	if ($d==0)
	{
		executeSQL($dbh, "CREATE TABLE [usaaa] (user_id INTEGER PRIMARY KEY, user_mail TEXT, user_password TEXT, user_level INTEGER)", null);
